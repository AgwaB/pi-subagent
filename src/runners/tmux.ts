		...
		try {
			const { stdout } = await execFileAsync(
				...
				[
					...
					"#{session_id}\t#{pane_id}",
					"-e",
					`PI_SUBAGENT_DURABLE_WORKER_BINDING_JSON=${durableBinding}`,
					tmuxCommand,
					...tmuxArgs,
				],
